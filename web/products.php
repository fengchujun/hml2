    ...
    <main class="content-area">
        ...
        <section id="category<?php echo $category['category_id']; ?>" class="category-section">
            <div class="category-header">
                <h1 class="category-title"><?php echo e($category['category_name']); ?></h1>
            ...
            <div class="products-grid">
                ...
                <div class="product-card" onclick="location.href='product-detail.php?id=<?php echo $product['goods_id']; ?>'">
                    <div class="product-image">
                        ...
                        ?>
                        <img src="<?php echo e($image_url); ?>" alt="<?php echo e($product['goods_name']); ?>">
                    </div>
                    <div class="product-info">
                        <h3 class="product-name"><?php echo e($product['goods_name']); ?></h3>
                        ...
                        <button class="view-detail-btn" onclick="event.stopPropagation(); location.href='product-detail.php?id=<?php echo $product['goods_id']; ?>'">查看详情</button>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
        ...
        <section class="category-section">
            <div class="category-header">
                <h1 class="category-title">暂无产品分类</h1>
                <p class="category-subtitle">敬请期待</p>
            </div>
        </section>
        <?php endif; ?>
    </main>
