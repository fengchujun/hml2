<template name="yq-avatar">
	<view>
		<image v-if="imgSrc.imgSrc" :src="imgSrc.imgSrc" @click="fSelect" :style="[iS]" class="my-avatar"></image>
		<canvas canvas-id="avatar-canvas" id="avatar-canvas" class="my-canvas" :style="{ top: sT, height: csH }" disable-scroll="false"></canvas>
		<canvas
			...
			@touchend="fEnd"
		></canvas>
		<canvas canvas-id="prv-canvas" id="prv-canvas" class="prv-canvas" disable-scroll="false" @touchstart="fHideImg" :style="{ height: csH, top: pT }"></canvas>
...
.oper {
	...
	/* padding: 10upx 20upx 80upx 20upx; */
	width: 100%;
	height: 100%;
	box-sizing: border-box;
	align-self: center;
